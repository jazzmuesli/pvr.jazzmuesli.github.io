...
const de: Messages = {
  ...
  "chart.hourly.legend_wind": "Wind-Ertrag",
  ...
  "chart.hourly.tooltip_wind": "Wind produziert",
  ...
  "control.market_margin": "Direktvermarkter-Marge",
  ...
  "wind.speed_mean": "Ø Windgeschw. (10m)",
  ...
  "co2.ev_wp_no_pv": "+ E-Auto + WP ohne PV: alles Netz",
  "co2.wp_diesel_grid": "+ WP, Diesel + Netz (ohne PV)",
  "co2.alternatives_label": "Ohne PV (Alternativen):",
  "co2.heating": "Heizung",
  ...
  "tooltip.self_consumption": "PV-Strom, der direkt im Haushalt verbraucht wird (direkt oder über Batterie). Geht nicht ins Netz und erwirtschaftet keinen Exporterlös, spart aber Netzbezug.",
  "tooltip.grid_import": "Netz-Import",
  "tooltip.grid_import_calc": "Strom, der aus dem öffentlichen Netz bezogen werden muss, weil PV und Batterie nicht ausreichen. Berechnung: Gesamtverbrauch − Eigenverbrauch.",
  "tooltip.import": "Netz-Import",
  "tooltip.export": "Export",
  "tooltip.export_calc": "PV-Überschuss, der nicht im Haushalt verbraucht wird und ins öffentliche Netz eingespeist wird. Entweder mit fester Vergütung oder als Direktvermarktung zum Spotpreis.",
  "tooltip.netto": "Netto",
  ...
  "tooltip.eeg_reference": "Anzulegender Wert (EEG): Festgelegte Vergütung je nach Anlagengröße (≤10 kWp, 10–40 kWp, >40 kWp). Basis für die Marktprämie bei Direktvermarktung.",
  "tooltip.eff_price_household": "Effektiver Strompreis, den der Haushalt tatsächlich bezahlt. PV-Deckung senkt den Preis, weil Eigenverbrauch als 0 ct/kWh zählt.",
  "tooltip.eff_price_heatpump": "Gemischter Strompreis, den die Wärmepumpe tatsächlich bezahlt. PV-Deckung senkt den Preis, weil Eigenverbrauch als 0 ct/kWh zählt.",
  "tooltip.eff_price_ev": "Gemischter Ladestrom-Preis des E-Autos. Nachtladen auf günstigem Tarif und PV-Überschuss mittags senken den Preis gegenüber dem Festpreis.",
  "tooltip.lcoe": "Stromgestehungskosten (LCOE): Durchschnittliche Kosten pro kWh über die Lebensdauer der Anlage. Berechnung: (Investition + laufende Kosten) / Gesamtstromproduktion, abgezinst mit kalkulatorischem Zinssatz (WACC). Entspricht dem Preis, ab dem sich die Anlage rechnen würde.",
  "tooltip.direktvermarktung": "Direktvermarktung: Statt fester Einspeisevergütung wird Strom zum Börsenstrompreis (Spot) verkauft und eine Marktprämie vom Netzbetreiber gezahlt. Vorteil: Batterie kann zu teuren Stunden entladen und den Spotpreis kassieren.",
  "tooltip.pv_share": "PV-Anteil: Anteil des Verbrauchs, der aus eigener PV-Produktion und Batterie gedeckt wird. Je höher, desto weniger Strom muss teuer aus dem Netz gekauft werden.",
  "tooltip.coverage_pv": "PV+Speicher-Deckung: Anteil des Verbrauchs, der aus eigener PV-Produktion und Batterie-Entladung gedeckt wird. Rest wird aus dem Netz gezogen.",
  "tooltip.coverage_grid": "Netzbezug: Strom, der aus dem öffentlichen Netz bezogen werden muss, weil PV und Batterie nicht ausreichen. Preis = fest oder Ø dynamisch.",
  "tooltip.dhw_hp": "Brauchwasser-Wärmepumpe: Erzeugt Warmwasser mit einer Wärmepumpe. Läuft im Mittags-PV-Block (11–15 Uhr), um möglichst viel eigenen Strom zu nutzen.",
  "tooltip.bwwp_midday": "Die Brauchwasser-Wärmepumpe läuft im Mittagsblock (11–15 Uhr), wenn die PV-Produktion am höchsten ist. So wird Warmwasser möglichst solar erzeugt.",
  "tooltip.heating_jaz": "Jahresarbeitszahl (JAZ): Nutzwärme (kWh) pro kWh Strom. JAZ 3 bedeutet: 1 kWh Strom erzeugt 3 kWh Wärme. Je höher, desto effizienter.",
  "tooltip.car_ev_price": "E-Auto-Strompreis (effektiv): PV-bewusster Effektivpreis des Ladestroms. Je mehr PV im Mix, desto günstiger.",
  "tooltip.car_diesel_saving": "Ersparnis: Was ein Diesel pro Jahr mehr kosten würde als das E-Auto, inkl. Wartung, Steuer, Versicherung. Der Betrag kann über die PV-Amortisationszeit investiert werden.",
  "tooltip.financeable": "Finanzierbarer Betrag: Wenn die PV-Anlage in X Jahren amortisiert ist, könnte man mit der gleichen jährlichen Ersparnis über X Jahre einen weiteren Betrag finanzieren (Barwert der Ersparnis über den Betrachtungszeitraum).",
  ...
  "opportunity.other_costs": "Nebenkosten",
  "opportunity.savings": "Ersparnis ggü.",
  "opportunity.per_year_finance": "/Jahr · Über die PV-Amortisationszeit",
  "opportunity.years_pv": "J. könntest du mit dieser Ersparnis zusätzlich investieren:",
  "opportunity.financeable_hint": "Barwert der jährlichen Ersparnis über den Betrachtungszeitraum",
  ...
  // Excel cell comments (hover annotations)
  "excel.comment.oil_price": "Standardannahme: 130 €/100L ≈ 1,30 €/L · Quelle: DESTATIS/EUROSTAT Energiepreisindex",
  "excel.comment.oil_heating_value": "1 Liter Heizöl ≈ 10 kWh · physikalischer Heizwert bei 15 °C",
  "excel.comment.oil_efficiency": "Moderne Ölkessel: 85–90 % · hier konservativ 85 % angenommen",
  "excel.comment.oil_chimney": "Jährliche Schornsteinfegerkosten · variiert je nach Region (150–300 €)",
  "excel.comment.gas_price": "Aktueller Gaspreis (inkl. Steuer & Netzentgelt) · Quelle: BDEW Gaspreisanalyse",
  "excel.comment.gas_efficiency": "Moderne Gaskessel: 90–95 % · hier 92 % angenommen",
  "excel.comment.gas_grid_fee": "Netzentgelt für Erdgas · steht auf Ihrer Gasrechnung",
  "excel.comment.gas_fixed_costs": "Grundgebühr + Schornsteinfeger + Wartung · steht auf Ihrer Gasrechnung",
  "excel.comment.gas_chimney": "Jährliche Schornsteinfegerkosten für Gas · variiert je nach Region",
  "excel.comment.jaz": "Jahresarbeitszahl = Nutzwärme / Strom · typisch 3,0–4,0 für Luft-Wasser-WP",
  "excel.comment.hp_electricity": "Jahresstrombedarf der Wärmepumpe · aus der 15-Min-Simulation",
  "excel.comment.hp_effective_price": "Effektiver Strompreis der WP: (Netzstrom + gratis PV) / Gesamtstrom",
  "excel.comment.ev_consumption": "Typischer Stromverbrauch: 15–20 kWh/100km · Quelle: ADAC/EU-Norm",
  "excel.comment.ev_maintenance": "Wartungskosten: 3–8 ct/km · E-Auto hat weniger Verschleiß als Verbrenner",
  "excel.comment.ev_tax": "Kfz-Steuer für E-Auto: 0 € (befreit bis 2030) · danach reduziert",
  "excel.comment.ev_insurance": "Sonstige Nebenkosten: Versicherung, Reifen, TÜV · vergleichbar mit Verbrenner",
  "excel.comment.diesel_consumption": "Typischer Dieselverbrauch: 5–7 L/100km · Quelle: ADAC",
  "excel.comment.diesel_price": "aktueller Dieselpreis · Quelle: ADAC-Tankpreisrechner",
  "excel.comment.diesel_maintenance": "Wartungskosten: 4–10 ct/km · Verbrenner haben mehr Verschleiß",
  "excel.comment.diesel_tax": "Kfz-Steuer für Diesel: je nach CO2-Ausstoß · 9,50 €/100ccm + CO2-Abgabe",
  "excel.comment.diesel_insurance": "Sonstige Nebenkosten: Versicherung, Reifen, TÜV · vergleichbar mit E-Auto",
  "excel.comment.baseline_cost": "Was der Strom kosten würde, wenn alles aus dem Netz käme (ohne PV)",
  "excel.comment.total_consumption": "Gesamtstromverbrauch aller aktivierten Verbraucher",
  "excel.comment.pv_yield": "Jahresertrag der PV-Anlage · aus Solarmodell-Simulation",
  "excel.comment.self_consumption": "PV-Produktion, die direkt verbraucht wird (ohne Netz·Zwischenspeicherung)",
  "excel.comment.grid_export": "Überschüssiger PV-Strom, der ins Netz eingespeist wird",
  "excel.comment.export_revenue": "Erlös aus PV-Einspeisung · abhängig von Einspeise-Modell",
  "excel.comment.import_cost": "Kosten für Strom aus dem Netz · für alle Verbraucher",
  "excel.comment.net_balance": "Export-Erlös minus Import-Kosten · positives Ergebnis = Gewinn",
  "excel.comment.self_consumption_rate": "Eigenverbrauch / PV-Ertrag · höher = mehr eigener Strom",
  "excel.comment.autarky": "Eigenverbrauch / Gesamtverbrauch · höher = unabhängiger vom Netz",
  "excel.comment.payback": "Amortisationszeit: Investition / jährliche Ersparnis · ohne Finanzierungskosten",
  "excel.comment.investment_total": "Gesamtkosten: Module + Wechselrichter + Batterie + Montage",
  "excel.comment.eff_price_total": "Gewichteter Strompreis über alle Verbraucher: Gesamtkosten / Gesamtstrom",
  "excel.comment.npv": "Kapitalwert (Net Present Value) · Barwert aller Cashflows über 20 Jahre",
  "excel.comment.irr": "Interne Rendite (Internal Rate of Return) · Rendite der Investition",
  "excel.comment.lcoe": "Levelized Cost of Electricity · Stromgestehungskosten der PV-Anlage",
...
const en: Messages = {
  ...
  "chart.hourly.legend_wind": "Wind yield",
  ...
  "chart.hourly.tooltip_wind": "Wind produced",
  ...
  "control.model": "Model",
  "control.market_margin": "Direct marketer margin",
  ...
  "wind.speed_mean": "Avg. wind speed (10m)",
  ...
  "co2.ev_wp_no_pv": "+ EV + HP without PV: all from grid",
  "co2.wp_diesel_grid": "+ HP, diesel + grid (no PV)",
  "co2.alternatives_label": "Without PV (alternatives):",
  "co2.heating": "Heating",
  ...
  "tooltip.self_consumption": "PV electricity consumed directly in the household (direct or via battery). Does not go to the grid or earn export revenue, but avoids grid imports.",
  "tooltip.grid_import": "Grid import",
  "tooltip.grid_import_calc": "Electricity that must be drawn from the public grid because PV and battery are insufficient. Formula: total consumption − self-consumption.",
  "tooltip.import": "Grid import",
  "tooltip.export": "Export",
  "tooltip.export_calc": "PV surplus not consumed in the household and fed into the public grid. Either at a fixed feed-in tariff or sold at the spot price via direct marketing.",
  "tooltip.netto": "Net",
  ...
  "tooltip.eeg_reference": "EEG reference value: Fixed tariff depending on system size (≤10 kWp, 10–40 kWp, >40 kWp). Basis for the market premium in direct marketing.",
  "tooltip.eff_price_household": "Effective electricity price the household actually pays. PV coverage lowers the price because self-consumption counts as 0 ct/kWh.",
  "tooltip.eff_price_heatpump": "Blended electricity price the heat pump actually pays. PV coverage lowers the price because self-consumption counts as 0 ct/kWh.",
  "tooltip.eff_price_ev": "Blended charging electricity price for the EV. Night charging on a cheap tariff and PV surplus at midday lower the price vs. the fixed rate.",
  "tooltip.lcoe": "Levelized Cost of Electricity (LCOE): Average cost per kWh over the system lifetime. Calculation: (Investment + ongoing costs) / total electricity production, discounted with WACC. Equals the break-even electricity price.",
  "tooltip.direktvermarktung": "Direct marketing: Instead of fixed feed-in, electricity is sold at the spot price and a market premium is paid by the grid operator. Advantage: battery can discharge during expensive hours and capture the spot price.",
  "tooltip.pv_share": "PV share: Share of consumption covered by own PV production and battery. The higher, the less expensive grid electricity you need to buy.",
  "tooltip.coverage_pv": "PV+battery coverage: Share of consumption covered by own PV production and battery discharge. Remainder is drawn from the grid.",
  "tooltip.coverage_grid": "Grid import: Electricity that must be drawn from the public grid because PV and battery are insufficient. Price = fixed or avg. dynamic.",
  "tooltip.dhw_hp": "Domestic hot water heat pump: Produces hot water using a heat pump. Runs in the midday PV block (11–15h) to maximize self-consumption.",
  "tooltip.bwwp_midday": "The domestic hot water heat pump runs in the midday block (11–15h) when PV production is highest. This way hot water is produced primarily from solar.",
  "tooltip.heating_jaz": "Seasonal COP (JAZ): Useful heat (kWh) per kWh electricity. COP 3 means: 1 kWh electricity produces 3 kWh heat. Higher = more efficient.",
  "tooltip.car_ev_price": "EV electricity price (effective): PV-aware effective price of charging electricity. The more PV in the mix, the cheaper.",
  "tooltip.car_diesel_saving": "Savings: What a diesel would cost more per year than the EV, incl. maintenance, tax, insurance. This amount can be invested over the PV payback period.",
  "tooltip.financeable": "Financeable amount: If the PV system pays back in X years, the same annual saving could finance an additional investment over X years (present value of the saving over the analysis horizon).",

  // Opportunity
  "opportunity.vs_hp": "vs. heat pump",
  ...
  "opportunity.other_costs": "Ancillary costs",
  "opportunity.savings": "Savings vs.",
  "opportunity.per_year_finance": "/yr · Over the PV payback period",
  "opportunity.years_pv": "yr you could additionally invest:",
  "opportunity.financeable_hint": "Present value of the annual saving over the analysis horizon",
  ...
  // Excel cell comments (hover annotations)
  "excel.comment.oil_price": "Standard assumption: 130 €/100L ≈ 1.30 €/L · source: DESTATIS/EUROSTAT energy price index",
  "excel.comment.oil_heating_value": "1 litre of heating oil ≈ 10 kWh · physical calorific value at 15 °C",
  "excel.comment.oil_efficiency": "Modern oil boilers: 85–90 % · conservatively assumed 85 % here",
  "excel.comment.oil_chimney": "Annual chimney sweep costs · varies by region (150–300 €)",
  "excel.comment.gas_price": "Current gas price (incl. tax & grid fee) · source: BDEW gas price analysis",
  "excel.comment.gas_efficiency": "Modern gas boilers: 90–95 % · assumed 92 % here",
  "excel.comment.gas_grid_fee": "Gas grid fee · found on your gas bill",
  "excel.comment.gas_fixed_costs": "Fixed charge + chimney sweep + maintenance · found on your gas bill",
  "excel.comment.gas_chimney": "Annual chimney sweep costs for gas · varies by region",
  "excel.comment.jaz": "Seasonal COP = useful heat / electricity · typically 3.0–4.0 for air-source heat pump",
  "excel.comment.hp_electricity": "Annual electricity demand of heat pump · from 15-min simulation",
  "excel.comment.hp_effective_price": "Effective HP electricity price: (grid + free PV) / total electricity",
  "excel.comment.ev_consumption": "Typical electricity consumption: 15–20 kWh/100km · source: ADAC/EU standard",
  "excel.comment.ev_maintenance": "Maintenance costs: 3–8 ct/km · EV has less wear than combustion engine",
  "excel.comment.ev_tax": "Vehicle tax for EV: 0 € (exempt until 2030) · then reduced",
  "excel.comment.ev_insurance": "Other ancillary costs: insurance, tyres, TÜV · comparable to combustion engine",
  "excel.comment.diesel_consumption": "Typical diesel consumption: 5–7 L/100km · source: ADAC",
  "excel.comment.diesel_price": "Current diesel price · source: ADAC fuel price calculator",
  "excel.comment.diesel_maintenance": "Maintenance costs: 4–10 ct/km · combustion engines have more wear",
  "excel.comment.diesel_tax": "Vehicle tax for diesel: depends on CO2 emissions · 9.50 €/100ccm + CO2 surcharge",
  "excel.comment.diesel_insurance": "Other ancillary costs: insurance, tyres, TÜV · comparable to EV",
  "excel.comment.baseline_cost": "What electricity would cost if everything came from the grid (without PV)",
  "excel.comment.total_consumption": "Total electricity consumption of all activated consumers",
  "excel.comment.pv_yield": "Annual PV yield · from solar model simulation",
  "excel.comment.self_consumption": "PV production consumed directly (without grid / battery storage)",
  "excel.comment.grid_export": "Surplus PV electricity fed into the grid",
  "excel.comment.export_revenue": "Revenue from PV feed-in · depends on feed-in model",
  "excel.comment.import_cost": "Cost of electricity from the grid · for all consumers",
  "excel.comment.net_balance": "Export revenue minus import cost · positive result = profit",
  "excel.comment.self_consumption_rate": "Self-consumption / PV yield · higher = more own electricity",
  "excel.comment.autarky": "Self-consumption / total consumption · higher = less grid-dependent",
  "excel.comment.payback": "Payback period: investment / annual savings · without financing costs",
  "excel.comment.investment_total": "Total cost: modules + inverter + battery + installation",
  "excel.comment.eff_price_total": "Weighted electricity price across all consumers: total cost / total electricity",
  "excel.comment.npv": "Net Present Value · present value of all cash flows over 20 years",
  "excel.comment.irr": "Internal Rate of Return · return on investment",
  "excel.comment.lcoe": "Levelized Cost of Electricity · electricity generation cost of PV system",
