...
export function incidenceCos(sun, tiltDeg, surfaceAzimuthDeg) {
...
export function poaIrradiance(latDeg, dayFloat, localHour, tiltDeg, surfaceAzimuthDeg) {
...
function rawStepEnergy(latDeg, dayFloat, localHour, tiltDeg, surfaceAzimuthDeg) {
...
export function pvProductionPerStep(input) {
...
export function monthlyTotals(perStep) {
