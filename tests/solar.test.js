...
import { declination, solarVector, incidenceCos, pvProductionPerStep, monthlyTotals, LOCATIONS, DEG, } from "../src/calc/solar";
...
describe("pv production", () => {
    const cfg = { peakKWp: 10, tiltDeg: 35, orientation: "south", location: "hamburg" };
